...
#define KLOG(fmt, args...) KLog(fmt, ##args)

#define KPRINTF(fmt, args...) KLog(fmt, ##args);

#define KTRACE KLog("E: %s", __FUNCTION__);

#define KLOG_LINE KLog("Line: %s, %d, %s", __FILE__, __LINE__, __FUNCTION__);
...
#define KPANIC(str)                                                            \
  {                                                                            \
    ...
    DisableInterrupts();                                                       \
    KLog("@ %s, %d, %s, %s", __FILE__, __LINE__, __FUNCTION__,                 \
         dcurrent->name);                                                      \
    KPanic(str);                                                               \
  }
